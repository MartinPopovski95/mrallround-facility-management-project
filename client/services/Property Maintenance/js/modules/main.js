import { fetchMaintenanceServiceData } from "./api.js";
import { renderMaintenanceServiceData, setLoading } from "./render.js";
...
const formHandler = new DynamicFormHandler('Property Maintenance', '/api/property-maintenance-service');
...
async function loadMaintenanceService(locale = "en") {
  setLoading(true);
  try {
    const data = await fetchMaintenanceServiceData(locale);

    renderMaintenanceServiceData(data);
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  initLanguageSwitch(loadMaintenanceService);
