import { fetchRenovationServiceData } from "./api.js";
import { renderRenovationServiceData, setLoading } from "./render.js";
...
const formHandler = new DynamicFormHandler('Renovation', '/api/renovation-service');
...
async function loadRenovationService(locale = "en") {
  setLoading(true);
  try {
    const data = await fetchRenovationServiceData(locale);
    renderRenovationServiceData(data);
